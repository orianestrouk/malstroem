# coding=utf-8
# -------------------------------------------------------------------------------------------------
# Additional drainage tool developed by Oriane Strouk (2026).
#
# This module provides utilities to simulate bluespot drainage processes using drainage points with
# associated capacities. Drainage curves are derived from bluespot hypsometry to account for
# time-dependent water level variations and storage evolution.
# -------------------------------------------------------------------------------------------------
